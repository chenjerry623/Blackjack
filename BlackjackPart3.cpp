...
void provideAdvice(CardArray& cards)
{
    ...
    else if (score >= 14 && cards.currentNumber >= 4)
    {
        // score >= 14 and has >= 4 cards
        cout << endl << "you should stand" << endl;
        cout << "your score is " << score << " and you only have " << cards.currentNumber << " cards, if you hit you are likely to go bust" << endl;
    }
    else if (score >= 11 && cards.currentNumber >= 6)
    {
        // score >= 11 and has >= 6 cards, that means most of small rank cards have been dealt, the possibility of getting a higher rank card is higher
        cout << endl << "you should stand" << endl;
        cout << "your score is " << score << ", but you have already dealt " << cards.currentNumber << " cards, if you hit you are likely to go bust" << endl;
    }
    else
    {
        cout << endl << "you should hit" << endl;
...
int blackjack(CardArray& deck)
{
    ...
    do
    {
        ...
        // dealing to player
        {
            ...
            {
                // check the player's score and give advice every iteration
