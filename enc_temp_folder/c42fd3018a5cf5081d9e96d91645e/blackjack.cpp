/*
Author: Jerry Chen
SFU Computing ID: jjc55
SFU Student ID: 301539072
Date: 2021-12-03
*/

/*
Advice:
I advise the stronger to hit if the value is 16 or lower
which was the general advice I found when I searched online
and also what the AI is programmed to do. hitting at 16 or lower
balances the chances of going bust with the chances of getting a better hand
at 50/50 or better, making it a reasonable risk. Additionally, if the player has
a score of 10 or lower, there is no risk of going bust (biggest addition is 10
since aces can be counted as 1). For scores of 10 or lower, I told the user
they should definately hit because there's no downside.

Additionally, if the player has a lot of cards that means
all of their cards must be low value, meaning there's mostly higher value cards
left in the deck, and thus, a higher chance of the player going bust.
Because of this, I have lower "cutoffs" for advising the player to stand
when the player already has a lot of cards in their hand

*/

/*
Academic honesty statement: I hereby confirm that this is my own work and 
I have not violated any of SFU’s Code of Academic Integrity and Good Conduct (S10.01).
*/
